...
class Address(Base):
    ...
    customer_id = Column(Integer, ForeignKey("public.tb_customers.customer_id"))
    city = Column(String)
...
class Order(Base):
    ...
    cancellation_reason_id = Column(Integer, ForeignKey("public.tb_cancellation_reasons.id"))
    customer_id = Column(Integer, ForeignKey("public.tb_customers.customer_id"))
    ...
    cancellationreason = relationship("CancellationReason", back_populates="order")
